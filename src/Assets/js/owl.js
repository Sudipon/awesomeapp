...
;(function($, window, document, undefined) {
	...
	Owl.prototype.initializeStage = function() {
		...
		this.$stage = $('<' + this.settings.stageElement + '>', {
			...
			"className": this.settings.stageOuterClass
		}));
		...
		if (!overwrites) {
			...
			if (settings.responsiveClass) {
				this.$element.attr('className',
					this.$element.attr('className').replace(new RegExp('(' + this.options.responsiveClass + '-)\\S+\\s', 'g'), '$1' + match)
				);
			}
		}
	...
	Owl.prototype.destroy = function() {
		...
		this.$element
			...
			.attr('className', this.$element.attr('className').replace(new RegExp(this.options.responsiveClass + '-\\S+\\s', 'g'), ''))
		...
		var tnLink,
			...
			create = function(path) {
				...
				if (settings.lazyLoad) {
					tnLink = $('<div/>',{
						"className": 'owl-video-tn ' + lazyClass,
						"srcType": path
					});
				} else {
					tnLink = $( '<div/>', {
